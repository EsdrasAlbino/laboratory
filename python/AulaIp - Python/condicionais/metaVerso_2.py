...
if local == "Queens" or local == "Times square" or local == "Central Park":
    ...
    if local == "Queens":
        ...
        print(
            f"Movimentação intensa de cria aqui pra variar, mas tem {ocorrencia}, não posso deixar isso acontecer!")
    elif local == "Central Park":
        print(
            f"Nossa... {ocorrencia}, depois de salvar vou pegar um hot dog meermo.")
else:
